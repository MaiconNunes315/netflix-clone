...
export default function Header() {
    ...
    return (
        ...
        <header className="header" >
            ...
            <nav>
                <img className="nav-img" src={logo} alt='netflix' />

                <div onMouseOver={() => setActiveClass(true)} onMouseOut={() => setActiveClass(false)} className="list-small">

                    <ul className={activeClass ? `active` : `hidden`}>
            ...
            <div className="header-right">
                ...
                <div className="search-box">
                    ...
                    <label htmlFor="search" >
                        ...
                        }} className={`search-icon ${showInput ? "left" : "right"} `} />
                ...
                <div className="div-bell">
                    <Bell className="bell" color="#FFFFFF" weight="bold" />
